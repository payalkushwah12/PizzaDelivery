...
<html lang="en">
  ...
  <a href="/home/dashboard/cart" class="text-secondary font-weight-bold mr-3">Cart <span class="badge badge-secondary">{{ $cartv }}</span></a>
      ...
      <a href="/home/logout" class="btn btn-outline-secondary font-weight-bold mr-3">Logout</a>
        ...
        <h1 class="text-info text-center" style="font-size:45px;">Order has been placed successfully!</h1>
    <p style="font-size:19px;" class="alert alert-success">You will receive notification by email with order details.</p>
    <hr>
    <a href="/home/dashboard" class="btn btn-block btn-secondary btn-large">Go an order some more</a>
