    ...
    <a href="/home/dashboard/cart" class="text-secondary font-weight-bold mr-3">Cart <span class="badge badge-secondary">{{ $cartv }}</span></a>
      <a href="/home/logout" class="btn btn-outline-secondary font-weight-bold mr-3">Logout</a>
        ...
        <section class="container jumbotron">
            ...
            <form method="post" action="/home/dashboard/updatepro" enctype="multipart/form-data">
             @csrf()    
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="mobile" value="{{$catdata->mobile}}"/>
                </div>
                <div class="form-group">
                    <label>Address</label>
                    <input type="text" class="form-control" name="address" value="{{$catdata->address}}"/>
                </div>
